...
import { DashboardTimeRangePicker } from "@/components/dashboard/controls/time-range-picker";
import {
  DropdownMenu,
  DropdownMenuContent,
...
import {
  ...
  getDashboardRefreshIntervalOption,
...
export function DashboardTimeControls({
  ...
  const refreshIntervalLabel =
    getDashboardRefreshIntervalOption(refreshInterval).shortLabel;
